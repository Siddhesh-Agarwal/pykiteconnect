...
class TestKiteConnectObject:
    ...
    @patch(KiteConnect, "_post", get_fake_token)
    def test_generate_session(self, kiteconnect):
        resp = kiteconnect.generate_session(request_token="<REQUEST-TOKEN>", api_secret="<API-SECRET>")
    ...
    @patch(KiteConnect, "_delete", get_fake_delete)
