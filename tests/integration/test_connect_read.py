...
from kiteconnect.types import MarginSegment, Exchange, TransactionType
import pytest
...
def test_request_pool():
    ...
    pool = {"pool_connections": 10, "pool_maxsize": 10, "max_retries": 0, "pool_block": False}
...
def test_set_access_token(kiteconnect: KiteConnect):
...
def test_set_session_expiry_hook(kiteconnect: KiteConnect):
...
def test_positions(kiteconnect: KiteConnect):
    """Test positions."""
...
def test_holdings(kiteconnect: KiteConnect):
    """Test holdings."""
...
def test_auction_instruments(kiteconnect: KiteConnect):
...
def test_margins(kiteconnect: KiteConnect):
    """Test margins."""
...
def test_margins_segmentwise(kiteconnect: KiteConnect):
    """Test margins for individual segments."""
    commodity = kiteconnect.margins(segment=MarginSegment.COMMODITY)
    assert isinstance(commodity, dict)


def test_orders(kiteconnect: KiteConnect):
    """Test orders get."""
    orders = kiteconnect.orders()
    assert isinstance(orders, list)


def test_order_history(kiteconnect: KiteConnect):
...
def test_trades(kiteconnect: KiteConnect):
    """Test trades."""
...
def test_order_trades(kiteconnect: KiteConnect):
    """Test individual order get."""
    trades = kiteconnect.trades()
...
def test_all_instruments(kiteconnect: KiteConnect):
...
def test_exchange_instruments(kiteconnect: KiteConnect):
    """Test mf instruments fetch."""
    instruments = kiteconnect.instruments(exchange=Exchange.NSE)
    mock_resp = kiteconnect._parse_instruments(utils.get_response("market.instruments"))
    utils.assert_responses(instruments, mock_resp)


def test_mf_orders(kiteconnect: KiteConnect):
    """Test mf orders get."""
...
def test_mf_order_info(kiteconnect: KiteConnect):
    """Test mf orders get."""
...
def test_mf_sips(kiteconnect: KiteConnect):
    """Test mf sips get."""
...
def test_mf_holdings(kiteconnect: KiteConnect):
    """Test mf holdings."""
...
def test_mf_instruments(kiteconnect: KiteConnect):
    """Test mf instruments fetch."""
...
def test_historical_data_intervals(max_interval: int, candle_interval: str, kiteconnect: KiteConnect):
...
def test_quote(kiteconnect: KiteConnect):
    """Test quote."""
...
def test_quote_ohlc(kiteconnect: KiteConnect):
    """Test ohlc."""
    instruments = ["NSE:INFY"]
...
def test_quote_ltp(kiteconnect: KiteConnect):
    """Test ltp."""
    instruments = ["NSE:INFY"]
...
def test_trigger_range(kiteconnect: KiteConnect):
    """Test ltp."""
    instruments = ["NSE:INFY", "NSE:RELIANCE"]

    # Test sending instruments as a list
    buy_resp = kiteconnect.trigger_range(TransactionType.BUY, *instruments)
    mock_resp = utils.get_json_response("market.trigger_range")["data"]
    utils.assert_responses(buy_resp, mock_resp)

    buy_resp = kiteconnect.trigger_range(TransactionType.SELL, *instruments)
    mock_resp = utils.get_json_response("market.trigger_range")["data"]
    utils.assert_responses(buy_resp, mock_resp)
